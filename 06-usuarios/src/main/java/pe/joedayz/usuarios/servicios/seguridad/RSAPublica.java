...
import javax.crypto.Cipher; //JCE = Java Cryptography Extension
...
public class RSAPublica {
	...
	public String encripta(byte[] bytes) throws ExcepcionCriptografia {
		try {
			...
			throw new ExcepcionCriptografia(e);
		}
	}
